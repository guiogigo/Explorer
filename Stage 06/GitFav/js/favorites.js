...
export class FavoritesView extends Favorites {
  ...
  createRow() {
    ...
    tr.innerHTML = `
      <td class="user">
        <img src="https://github.com/guiogigo.png" alt="">
        <a href="https://github.com/guiogigo" target="_blank">
          <p>Guilherme Batista</p>
          <span>guiogigo</span>
        </a>
      </td>
    ...
    document.querySelector('#noFav').classList.add('hide')
    return tr
  }
